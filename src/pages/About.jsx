...
const About = () => {
    return (
        <div className="bg-stone font-rubik py-20 px-6 md:px-32 lg:px-40 xl:px-72 text-justify text-sm ">
            <div>
            ...
            <div>
                <p className="font-righteous text-2xl lg:text-4xl font-bold mt-20 mb-10 text-center">Our History</p>
                <div className="">
