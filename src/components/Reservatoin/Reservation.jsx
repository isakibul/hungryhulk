...
const Reservation = () => {
    return (
        <div className="mt-20 mx-6 md:mx-10 flex flex-col items-center lg:flex-row">
            <div className="text-center lg:flex flex-col lg:text-start lg:items-start lg:w-3/5">
                ...
                <button className="py-3 mt-5 px-6 bg-yellow-400 rounded-full outline outline-2 outline-yellow-400 hover:outline-white ease in duration-300">Make Reservation</button>
            </div>
            <div>
