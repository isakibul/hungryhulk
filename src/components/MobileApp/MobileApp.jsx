...
import setMenu from "../../../public/set-menu.png";

const MobileApp = () => {
    return (
        <div className="mt-20 mx-2 p-2 md:p-4 lg:p-8 md:mx-8 lg:mx-14 bg-stone-200 flex flex-col gap-5 items-center justify-center lg:flex-row rounded-lg lg:rounded-xl">
            <div className="flex flex-col items-center text-center lg:items-start lg:text-start lg:w-2/5">
                ...
                <div className="flex items-center justify-center gap-4">
                    <div className="flex gap-1 text-amber-950 bg-yellow-300 py-1.5 px-6 xl:px-8 rounded-full outline outline-yellow-400 outline-1 cursor-pointer hover:outline-white ease-in duration-300">
                    ...
                    <div className="flex gap-1 items-center justify-center outline outline-1 text-amber-950 outline-yellow-300 py-1.5 px-6 xl:px-8 rounded-full cursor-pointer hover:shadow-lg ease-in duration-300">
