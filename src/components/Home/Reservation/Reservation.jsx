        ...
        <div className="relative h-screen my-28">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center backdrop-blur-[3px]">
                <div className="flex flex-col items-center justify-center w-4/5 md:w-3/5 p-8 bg-black bg-opacity-50 rounded-md">
                    <p className="font-righteous text-base md:text-4xl lg:text-5xl font-bold my-5">Do You Have Any Dinner Plan Today? <br /> Reserve Your Table!</p>
                    <p className="text-xs lg:text-base text-gray-800">Make online reservations, read restaurant reviews from diners, and earn points towards free meals. OpenTable is a real-time online reservation.</p>
